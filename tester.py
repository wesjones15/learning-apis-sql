...
try:
    ...
    if resp['status'] != '200':
        raise Exception('1Received an unsuccessful status code of %s' % resp['status'])
    ...
    resp, result = h.request(url,'POST')
    if resp['status'] != '200':
        raise Exception('2Received an unsuccessful status code of %s' % resp['status'])
    print (json.loads(result))
    ...
    resp, result = h.request(url,'POST')
    if resp['status'] != '200':
        raise Exception('3Received an unsuccessful status code of %s' % resp['status'])
    ...
    resp, result = h.request(url,'POST')
    if resp['status'] != '200':
        raise Exception('4Received an unsuccessful status code of %s' % resp['status'])
    print (json.loads(result))
    ...
    resp, result = h.request(url,'POST')
    if resp['status'] != '200':
        raise Exception('5Received an unsuccessful status code of %s' % resp['status'])
    print (json.loads(result))
